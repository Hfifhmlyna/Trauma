...
if role == "Siswa (Menulis)":
    ...
    with col_kanan:
        o1 = st.select_slider("6. Seberapa sering kamu merasa sedih atau terganggu secara emosional setelah membaca cerita yang mengandung konflik?", options=[1, 2, 3, 4, 5], key="o1")
        o2 = st.select_slider("7. Seberapa sering kamu merasa gelisah atau tidak aman saat melakukan kegiatan membaca atau menulis narasi?", options=[1, 2, 3, 4, 5], key="o2")
        o3 = st.select_slider("8. Seberapa sering kamu merasa tegang atau terlalu waspada saat sedang mengerjakan tugas menulis di kelas?", options=[1, 2, 3, 4, 5], key="o3")
        o4 = st.select_slider("9. Seberapa sering kamu menyalahkan diri sendiri atau merasa menyesal setelah menuliskan perasaan negatif ke dalam narasi?", options=[1, 2, 3, 4, 5], key="o4")
        o5 = st.select_slider("10. Seberapa sering kamu merasa sulit fokus atau merasa asing dengan perasaanmu sendiri setelah menyelesaikan tugas literasi?", options=[1, 2, 3, 4, 5], key="o5")
